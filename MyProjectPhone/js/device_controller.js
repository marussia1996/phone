...
(function() {
	...
	function left_up()
	{
		console.log("[device_controller::left_up]");
        publish("say", "left_up");
	}
	
	function left_down()
	{
		console.log("[device_controller::left_down]");
        publish("say", "left_down");
	}
	
	function right_up()
	{
		console.log("[device_controller::right_up]");
        publish("say", "right_up");
	}
	
	function right_down()
	{
		console.log("[device_controller::right_down]");
        publish("say", "right_down");
	}
	
	
	function restart()
	{
		console.log("[device_controller::restart]");
        publish("say", "restart");
	}
